...
const Contact: React.FC = () => {
  ...
  const handleSendEmail = (e: React.FormEvent) => {
    ...
    // Generic mailto for the form to support all email clients
    window.location.href = `mailto:prasathr3009@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
    ...
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="grid gap-8">
        ...
        <div className="grid grid-cols-3 gap-4">
             <a href="https://wa.me/917299933882" target="_blank" rel="noopener noreferrer" className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-green-500/20 hover:border-green-200 transition-all text-center group flex flex-col items-center justify-center h-32">
             ...
             <a 
                href="https://mail.google.com/mail/?view=cm&fs=1&to=prasathr3009@gmail.com" 
                target="_blank" 
        ...
        <div className="grid md:grid-cols-2 gap-8">
                 ...
                 <Card className="h-full bg-slate-50 border-slate-200">
                     ...
                     <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-700">Phone Numbers</h4>
                                <a href="tel:+917299933882" className="block text-slate-600 hover:text-teal-600 transition-colors">+91 72999 33882</a>
                                <a href="tel:+917200953082" className="block text-slate-600 hover:text-teal-600 transition-colors">+91 72009 53082</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:prasathr3009@gmail.com" className="block text-slate-600 hover:text-teal-600 transition-colors">prasathr3009@gmail.com</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600">Valparai, Coimbatore District</p>
             ...
             <Card className="border-t-4 border-t-teal-500">
                <div className="mb-6">
                    ...
                    <p className="text-slate-500 text-sm mt-1">Have a query? Fill out the form below to send an email directly.</p>
                </div>
                ...
                <form onSubmit={handleSendEmail} className="space-y-4">
                    ...
                    <button type="submit" className="group w-full relative overflow-hidden bg-gradient-to-r from-teal-500 to-blue-600 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95">
                        ...
                        <div className="relative flex items-center justify-center gap-2">
                            Send Message via Email <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                        </div>
                    </button>
                </form>
            </Card>
